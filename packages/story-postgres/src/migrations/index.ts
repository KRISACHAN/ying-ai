...
export const storyPostgresMigrations = [
  {
    id: "001-story-schema",
    sql: storySchemaSql,
  },
...
export async function runStoryPostgresMigrations(client: StoryPostgresClient): Promise<void> {
  for (const migration of storyPostgresMigrations) {
