...
使用 PostgreSQL 前先按
[`packages/memory-postgres/README.zh-CN.md`](../../packages/memory-postgres/README.zh-CN.md)
...
验收记录：[`.code-reviews/companion/v1.1/acceptance/manual-verification.md`](../../.code-reviews/companion/v1.1/acceptance/manual-verification.md)
